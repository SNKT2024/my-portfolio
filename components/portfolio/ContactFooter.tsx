        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
          {socialLinks.map((link) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 px-6 py-3.5 bg-white text-black text-sm font-black uppercase border-2 border-black shadow-[3px_3px_0px_0px_#000] hover:bg-black hover:text-white hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 transition-all"
            >
